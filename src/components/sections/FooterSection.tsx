  ...
  return (
    <footer className="text-center text-gray-400 mt-8 mb-6">
      <p className="text-lg font-medium">
        &copy; {currentYear}{" "}
        {language === "da"
          ? "af Mads Dittmann Villadsen - Alle rettigheder forbeholdt"
          : "by Mads Dittmann Villadsen - All rights reserved"}
      </p>
      <p className="text-md text-white font-medium mt-2">{time}</p>
      <p className="text-sm text-gray-500">
        {language === "da" ? "Lokal tid i " : "Local time in"} Aarhus, Denmark
      </p>
      <p className="text-sm mt-6 text-gray-500">
        {language === "da" ? "Stolt bygget med" : "Proudly built with"}{" "}
        <a
