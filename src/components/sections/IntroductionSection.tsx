    ...
    >
        ...
        <div className="flex flex-col gap-6 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-md font-bold text-white mb-2">
                  Hey, {language === "da" ? "Jeg er" : "I'm"} Mads!
                </h1>
            ...
            <div className="flex flex-wrap gap-2 justify-start sm:justify-end">
              <a
                href="https://www.linkedin.com/in/ditz3n/"
                target="_blank"
          ...
          <p
            className={`text-white font-bold max-w-[600px] leading-snug ${language === "da" ? "text-2xl" : "text-3xl"}`}
          >
            {language === "da"
              ? "Passioneret omkring at skabe dynamiske og skalerbare webapplikationer."
              : "Passionate about crafting dynamic and scalable web applications."}
          </p>

          <p
            className={`text-white/60 max-w-[600px] leading-relaxed ${language === "da" ? "text-md" : "text-lg"}`}
          >
            {language === "da"
              ? "Jeg har en dyb passion for at bygge moderne, responsive webapps ved hjælp af React og udforske de nyeste webteknologier."
              : "I have a deep passion for building modern, responsive web apps using React and exploring the latest web technologies."}
          </p>
        </div>
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(50, 50, 50, 0.7) 0%, rgba(34, 34, 34, 0.3) 30%, transparent 70%)",
          }}
        ></div>
        <img
